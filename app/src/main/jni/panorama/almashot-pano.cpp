...
extern "C" JNIEXPORT jint JNICALL Java_com_zihuatanejo_finalcamera_plugins_processing_panorama_AlmashotPanorama_initialize
(
	JNIEnv* env,
	jclass
)
...
extern "C" JNIEXPORT jint JNICALL Java_com_zihuatanejo_finalcamera_plugins_processing_panorama_AlmashotPanorama_release
(
	JNIEnv*,
	jclass
)
...
extern "C" JNIEXPORT jintArray JNICALL Java_com_zihuatanejo_finalcamera_plugins_processing_panorama_AlmashotPanorama_process
(
	JNIEnv* env,
	jclass,
	jint width,
