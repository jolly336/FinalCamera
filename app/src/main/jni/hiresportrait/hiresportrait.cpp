...
JNIEXPORT void JNICALL Java_com_zihuatanejo_finalcamera_plugins_capture_hiresportrait_HiresPortraitCapturePlugin_Initialize
(
	JNIEnv* env,
	jobject thiz
)
...
JNIEXPORT void JNICALL Java_com_zihuatanejo_finalcamera_plugins_capture_hiresportrait_HiresPortraitCapturePlugin_Release
(
	JNIEnv* env,
	jobject thiz
)
...
JNIEXPORT int JNICALL Java_com_zihuatanejo_finalcamera_plugins_capture_hiresportrait_HiresPortraitCapturePlugin_SetFrontFrame
(
	JNIEnv* env,
	jobject thiz,
	jbyteArray data,
...
JNIEXPORT int JNICALL Java_com_zihuatanejo_finalcamera_plugins_capture_hiresportrait_HiresPortraitCapturePlugin_CheckRearAlignment
(
	JNIEnv* env,
	jobject thiz,
	jbyteArray data,
