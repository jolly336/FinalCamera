...
public final class CalendarResultHandler extends ResultHandler
{
	 ...
	 *            The start time
	 * @param allDay
	 *            if true, event is considered to be all day starting from start
	 *            time
	 * @param end
	 ...
	 *            attendees to invite
	 */
	private void addCalendarEvent(String summary, Date start, boolean allDay, Date end, String location,
			String description, String[] attendees)
	{
