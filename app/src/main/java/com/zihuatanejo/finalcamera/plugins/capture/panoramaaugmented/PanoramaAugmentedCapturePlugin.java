...
package com.zihuatanejo.finalcamera.plugins.capture.panoramaaugmented;
...
import com.zihuatanejo.finalcamera.opencam.PluginCapture;
...
import com.zihuatanejo.finalcamera.util.HeapUtil;
...
/* <!-- +++
 ...
 import com.zihuatanejo.finalcamera_plus.PluginCapture;
 ...
 import com.zihuatanejo.finalcamera_plus.ui.GUI.CameraParameter;
...
public class PanoramaAugmentedCapturePlugin extends PluginCapture
{
	...
	{
		ApplicationScreen.instance.disableCameraParameter(GUI.CameraParameter.CAMERA_PARAMETER_SCENE, true, false, true);
	...
	private void stopCapture()
	{
		...
		final LinkedList<AugmentedPanoramaEngine.AugmentedFrameTaken> frames = this.engine.retrieveFrames();
		...
		if (frames.size() > 0)
		{
			...
			float angleY = 0;
			float angleR = 0;
			final Iterator<AugmentedPanoramaEngine.AugmentedFrameTaken> iterator = frames.iterator();
			AugmentedPanoramaEngine.AugmentedFrameTaken frame = iterator.next();
