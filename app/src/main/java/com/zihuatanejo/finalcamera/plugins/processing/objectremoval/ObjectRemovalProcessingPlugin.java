...
package com.zihuatanejo.finalcamera.plugins.processing.objectremoval;
...
import com.zihuatanejo.finalcamera.util.Size;
...
public class ObjectRemovalProcessingPlugin extends MultiShotProcessingPlugin {
    ...
    private void drawObjectRectOnBitmap(Bitmap bitmap, AlmaCLRShot.ObjectInfo[] objInfo, AlmaCLRShot.ObjBorderInfo[] boderInfo) {
        float ratio = 0.f;
        ...
        int i = 0;
        for (AlmaCLRShot.ObjectInfo obj : objInfo) {
        ...
        for (AlmaCLRShot.ObjBorderInfo obj : boderInfo) {
            if (obj == null) {
                continue;
            }
            if (obj.getThumbnail() == null) {
    ...
    private AlmaCLRShot.OnProcessingListener mOnProcessingListener = new AlmaCLRShot.OnProcessingListener() {

        @Override
        public void onObjectCreated(AlmaCLRShot.ObjectInfo objInfo) {
        }

        @Override
        public void onProcessingComplete(
                AlmaCLRShot.ObjectInfo[] objInfoList) {
        }
