...
package com.zihuatanejo.finalcamera.plugins.vf.focus;
...
import com.zihuatanejo.finalcamera.opencam.PluginViewfinder;
import com.zihuatanejo.finalcamera.opencam.SoundPlayer;
...
import com.zihuatanejo.finalcamera_plus.PluginViewfinder;
import com.zihuatanejo.finalcamera_plus.R;
import com.zihuatanejo.finalcamera_plus.SoundPlayer;
+++ --> */
...
public class FocusVFPlugin extends PluginViewfinder {
    ...
    public void onCameraParametersSetup() {
        ...
        LayoutParams layout = mFocusIndicator.getLayoutParams();
    ...
    public void onTouchFocusAndMeteringArea(MotionEvent e) {
        ...
        } else if (e.getAction() == MotionEvent.ACTION_UP) { // Just show the indicator in all other cases.
            autoFocus();
            // updateFocusUI();
