...
package com.zihuatanejo.finalcamera.plugins.capture.multishot;
...
public class MultiShotCapturePlugin extends PluginCapture
{
	...
	{
		ApplicationScreen.getGUIManager().filterCameraParameter(GUI.CameraParameter.CAMERA_PARAMETER_FLASH, new int[]{CameraParameters.FLASH_MODE_SINGLE, CameraParameters.FLASH_MODE_OFF});
	}
