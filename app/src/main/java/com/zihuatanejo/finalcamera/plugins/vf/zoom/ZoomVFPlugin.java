...
package com.zihuatanejo.finalcamera.plugins.vf.zoom;
...
import com.zihuatanejo.finalcamera.ui.VerticalSeekBar;
...
public class ZoomVFPlugin extends PluginViewfinder
{
	...
	private void initZoomButtons()
	{
		...
		mButtonZoomIn.setOnTouchListener(new OnTouchListener()
		{
		...
		mButtonZoomOut.setOnTouchListener(new OnTouchListener()
		{
