...
package com.zihuatanejo.finalcamera.plugins.processing.sequence;
...
public class SequenceProcessingPlugin extends MultiShotProcessingPlugin implements OrderControl.SequenceListener
{
	...
	private class ProcessingTask extends AsyncTask<Void, Void, Void>
	{
		...
		protected Void doInBackground(Void... params)
		{
			...
			CameraController.Size imageSize = CameraController.getCameraImageSize();
			CameraController.Size input = new CameraController.Size(imageSize.getWidth(), imageSize.getHeight());
			int minSize = 1000;
			if (mMinSize == 0)
			{
				minSize = 0;
