...
import com.zihuatanejo.finalcamera.opencam.ui.SeekBarPreference;
...
/* <!-- +++
 import com.zihuatanejo.finalcamera_plus.ui.SeekBarPreference;
 import com.zihuatanejo.finalcamera_plus.cameracontroller.CameraController;
 import com.zihuatanejo.finalcamera_plus.cameracontroller.CameraController.Size;
 +++ --> */
//<!-- -+-
...
public class Fragment extends PreferenceFragment implements OnSharedPreferenceChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (upscalePref != null)
		{
			CameraController.Size size = CameraController.getMaxCameraImageSize(CameraController.YUV);
			long resMpx = 0;
			float mpix = 0.0f;
			if (size != null)
			{
