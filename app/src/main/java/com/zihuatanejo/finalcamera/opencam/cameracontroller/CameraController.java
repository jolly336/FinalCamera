...
/* <!-- +++
 package com.zihuatanejo.finalcamera_plus.cameracontroller;
 +++ --> */
// <!-- -+-
package com.zihuatanejo.finalcamera.opencam.cameracontroller;
...
import com.zihuatanejo.finalcamera.cameraremote.PictureCallbackSonyRemote;
import com.zihuatanejo.finalcamera.cameraremote.ServerDevice;
import com.zihuatanejo.finalcamera.cameraremote.ZoomCallbackSonyRemote;
...
import com.zihuatanejo.finalcamera.opencam.PluginManagerInterface;
...
/* <!-- +++
 ...
 import com.zihuatanejo.finalcamera_plus.PluginManagerInterface;
 import com.zihuatanejo.finalcamera_plus.R;
 +++ --> */

public class CameraController implements Camera.PictureCallback, AutoFocusCallback, Camera.ErrorCallback,
    ...
    protected static List<Size> ResolutionsSizeList;
    ...
    public static List<Size> MultishotResolutionsSizeList;
    public static List<String> MultishotResolutionsIdxesList;
    public static List<String> MultishotResolutionsNamesList;

    public static List<Size> SupportedVideoSizesList;

    public static List<Size> ResolutionsVideoList;

    public static List<String> ColorEffectsNamesList;

    public static List<Integer> FastIdxelist;

    protected static List<Size> SupportedPreviewSizesList;
    protected static List<Size> SupportedPictureSizesList;
...
//					|| (!isMotoXPure && !isFlex2 && !isNexus5or6 && !isAndroidOne  && !isOnePlusTwo/*&& !isGalaxyS6 &&*/ /* && !isG4*/))
    ...
    private static void fillPreviewSizeList() {
        if (!CameraController.isRemoteCamera()) {
            CameraController.SupportedPreviewSizesList = new ArrayList<Size>();
            if (!isCamera2) {
                try {
    ...
    private static void fillPictureSizeList() {
        CameraController.SupportedPictureSizesList = new ArrayList<Size>();
        if (!isCamera2) {
            if (camera != null) {
                try {
    ...
    public static void populateCameraDimensionsForMultishots() {
        ...
        CameraController.MultishotResolutionsSizeList = new ArrayList<Size>(
    ...
    public static List<Size> getSupportedPreviewSizes() {
        if (!CameraController.isRemoteCamera()) {
            ...
            if (!CameraController.isCamera2) {
                if (CameraController.SupportedPreviewSizesList != null) {
                    List<Size> sizes = SupportedPreviewSizesList;
...
//				Camera2Controller.setupImageReadersCamera2();
        ...
        if (!CameraController.isRemoteCamera()) {
            if (!CameraController.isCamera2) {
                if (CameraController.SupportedPictureSizesList != null) {
                    pictureSizes = new ArrayList<Size>(CameraController.SupportedPictureSizesList);
    ...
    public static List<Size> getSupportedVideoSizes() {
        List<Size> videoSizes = new ArrayList<Size>();
        if (!CameraController.isCamera2) {
            if (camera != null && camera.getParameters() != null) {
        ...
        SupportedVideoSizesList = new ArrayList<Size>(videoSizes);
        return videoSizes;
    }
