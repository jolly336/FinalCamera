...
package com.zihuatanejo.finalcamera.ui;
...
public class ShutterSwitch extends View {
     ...
     *                 default styling.
     * @param defStyle An attribute ID within the active theme containing a reference
     ...
     * switch drawables.
     *
     * @param pixels Minimum height of the switch in pixels
