...
package com.zihuatanejo.finalcamera.util;
...
public class AppWidgetNotifier
{
	...
	public static final boolean isABCWidgetInstalled(Activity activity)
	{
		try
		{
			activity.getPackageManager().getInstallerPackageName("com.zihuatanejo.finalcamerawidget");
	...
	private static void showNotifierDialog(final Activity mContext, final SharedPreferences prefs)
	{
		...
		b1.setOnClickListener(new OnClickListener()
		{
			...
			{
				MainScreen.callStoreInstall(mContext, "com.zihuatanejo.finalcamerawidget");
