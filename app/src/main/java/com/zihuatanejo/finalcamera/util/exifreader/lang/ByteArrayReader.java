...
package com.zihuatanejo.finalcamera.util.exifreader.lang;
...
public class ByteArrayReader implements BufferReader
{
    ...
    @com.zihuatanejo.finalcamera.util.exifreader.lang.annotations.SuppressWarnings(value = "EI_EXPOSE_REP2", justification = "Design intent")
